...
async function globalSetup() {
  ...
  if (Object.keys(authData.extraHTTPHeaders).length === 0) {
    throw new Error('No authentication credentials found for detected schemes (API Key or OAuth2). Please set API_KEY_VALUE or OAUTH_ACCESS_TOKEN environment variables.');
  }
